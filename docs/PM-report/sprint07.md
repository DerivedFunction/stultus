...
2. What technical debt remains?
   ...
   > - We will need to implement a likeData table to store the likes, especially for users.
   > - There is still some debt remaining for Web, as some code could be refactored
   > - The UI experience compared to other teams remain okay but not great.
...
3. If there was any remaining Phase 1 functionality that needed to be implemented in Phase 1', what did the PM do to assist in the effort of getting this functionality implemented and operating properly?
   > Nothing important missing that we need the PM
